...
SWEP.Description = [[The m4a1 pistol or PM (Russian: Пистолет Макарова, Pistolet m4a1a) is a 9x18mm semi-automatic pistol designed by Nikolay m4a1. It became the Soviet Union's standard military and police sidearm in 1951. The m4a1 pistol remained in wide front-line service with Soviet military and police until and beyond the end of the USSR in 1991. Variants of the pistol remain in production in Russia, China, and Bulgaria.]]
...
SWEP.ShellModel = "models/weapons/shells/556x45.mdl"
...
SWEP.ShootSound = path .. "m4a1_fp.wav"
SWEP.DistantShootSound = path .. "m4a1_dist.wav"
SWEP.ShootSoundSilenced = path .. "m4a1_suppressed_fp.wav"
SWEP.DryFireSound = path .. "handling/m4a1_empty.wav"
...
sound.Add({
	name = 			"Weapon_m4a1.Maghit",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/m4a1/handling/m4a1_maghit.wav"
    }),
sound.Add({
...
sound.Add({
	...
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/m4a1/handling/m4a1_empty.wav"
    }),
    sound.Add({
	name = 			"Weapon_m4a1.safety",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/m4a1/handling/m4a1_safety.wav"
    }),
sound.Add({
