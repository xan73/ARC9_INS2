...
SWEP.Description = [[The SKS (Russian: Самозарядный карабин системы Симонова, Samozaryadniy Karabin sistemy Simonova; English: Self-loading Carbine of [the] Simonov system) or the SKS-45 as its complete designation is known as, is a Soviet semi-automatic carbine chambered for the 7.62×39mm round, designed in 1943 by Sergei Gavrilovich Simonov. In the early 1950s, the Soviets took the SKS carbine out of front-line service and replaced it with the AK-47; however, the SKS remained in second-line service for decades.]]
...
SWEP.CustomizePos = Vector(13, 26, 2)
...
local path = "weapons/sks/"
local common = "weapons/"


SWEP.ShootSound = path .. "sks_fp.wav"
SWEP.DistantShootSound = path .. "sks_dist.wav"
SWEP.ShootSoundSilenced = path .. "sks_suppressed_fp.wav"
SWEP.DryFireSound = path .. "handling/sks_empty.wav"
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Tactical",
        Category = {"ins2_pistol_laser_lights", "ins2_sks_flashlight"},
        Bone = "weapon",
...
sound.Add({
	name = 			"Weapon_sks.Maghit",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/sks/handling/sks_maghit.wav"
    }),
sound.Add({
...
sound.Add({
	name = 			"Weapon_sks.safety",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/sks/handling/sks_safety.wav"
    }),
sound.Add({
