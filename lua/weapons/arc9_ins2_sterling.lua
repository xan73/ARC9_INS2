...
local path = "weapons/sterling/"
local common = "weapons/"


SWEP.ShootSound = path .. "sterling_fp.wav"
SWEP.DistantShootSound = path .. "sterling_dist.wav"
SWEP.ShootSoundSilenced = path .. "sterling_suppressed_fp.wav"
SWEP.DryFireSound = path .. "handling/sterling_empty.wav"
...
SWEP.Attachments = {
    ...
    {
        PrintName = "STICKER",
        StickerModel = "models/weapons/arc9_fas/stickers/sterling_a.mdl",
        Category = "stickers",
    },
...
sound.Add({
	name = 			"Weapon_sterling.Boltrelease",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/sterling/handling/sterling_boltrelease.wav"
    }),
sound.Add({
...
sound.Add({
	name = 			"Weapon_sterling.safety",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/sterling/handling/sterling_safety.wav"
    }),
sound.Add({
